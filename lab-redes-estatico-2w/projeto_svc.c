...
prog_100(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case GET_MAJOR_MINOR:
		...
		_xdr_result = (xdrproc_t) xdr_pair;
		local = (bool_t (*) (char *, void *,  struct svc_req *))get_major_minor_100_svc;
		break;
	...
	if (!prog_100_freeresult (transp, _xdr_result, (caddr_t) &result))
